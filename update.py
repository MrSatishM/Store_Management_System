...
class Database:
    def __init__(self, master, *args, **kwargs):
        ...
        self.btn_add = Button(master, text = "Update the Database", width =20, height=2,bg='steelblue',fg='white', command= self.update)
        self.btn_add.place(x = 560, y=520)
    ...
    def update(self, *args, **kwargs):
        ...
        query = "UPDATE inventory SET name=?, stock=? , cp=? ,sp=? , totalcp=? , totalsp=? WHERE id = ?"
